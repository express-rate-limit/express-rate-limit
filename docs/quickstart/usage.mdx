...
Take a look at the [configuration page](/docs/references/configuration) for a
...
[guide](/docs/guides/troubleshooting-proxy-issues) to troubleshooting proxy
issues.
...
option, take a look at the [config page](docs/references/configuration#store).

For a tutorial on how to create your own store, see
[this](/docs/guides/creating-a-store).
