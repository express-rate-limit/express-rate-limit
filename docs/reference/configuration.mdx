...
In a 128 bit IPv6 address, the number of bits in this setting will be kept, and
the rest will be ignored when determining the user's IP address. A smaller
...
apply different subnets to different users.
