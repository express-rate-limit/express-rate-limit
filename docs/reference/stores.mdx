...
| [rate-limit-sqlite](https://www.npmjs.com/package/rate-limit-sqlite)                                      | A [SQLite](https://sqlite.org/index.html)-backed store that uses the [native Node.js SQLite API](https://nodejs.org/api/sqlite.html).                                                              | Modern              |
