...
> and [8.0.2](https://github.com/express-rate-limit/express-rate-limit/releases/tag/v8.0.2).

### Security

- Fixed [ghsa-46wh-pxpv-q5gq](https://github.com/express-rate-limit/express-rate-limit/security/advisories/GHSA-46wh-pxpv-q5gq).
