---
title: 'Contributing'
description: 'Thanks for your interest in contributing to `express-rate-limit`! This guide will show you how to set up your environment and contribute to this library.'
icon: 'handshake'
---
