...
const parseOptions = (passedOptions: Partial<Options>): Configuration => {
	...
	// The actual default is generated by `setDraft8Headers()`, so if it is
	// undefined, set it to `rl` for now.
	const identifier = notUndefinedOptions.identifier ?? 'rl'
	...
	const config: Configuration = {
		...
		standardHeaders,
		// The `identifier`, if undefined, is resolved to `rl` so that the actual
