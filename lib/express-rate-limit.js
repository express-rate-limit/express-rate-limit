...
function RateLimit(options) {
  ...
  function rateLimit(req, res, next) {
    const _rateLimit = _skip => (_skip ? next() : doRateLimit(req, res, next));
    const skip = options.skip(req, res);
    skip instanceof Promise ? skip.then(_rateLimit, next) : _rateLimit(skip);
  }

  function doRateLimit(req, res, next) {
