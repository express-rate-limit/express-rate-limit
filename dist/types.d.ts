 ...
 * @public
 */
export declare type IncrementCallback = (error: Error | undefined, hit: number, resetTime: Date | undefined) => void;
/**
 ...
 * @public
 */
export declare type KeyGeneratingMiddleware = (request: Express.Request, response: Express.Response) => string | Promise<string>;
/**
 ...
 * @public
 */
export declare type ShouldSkipMiddleware = (request: Express.Request, response: Express.Response) => boolean | Promise<boolean>;
/**
...
export interface Options {
     ...
     */
    readonly max: number | ((request: Express.Request, response: Express.Response) => number | Promise<number>);
    /**
     ...
     * rate-limited.
     */
    readonly handler: (request: Express.Request, response: Express.Response, optionsUsed: Options) => void;
    /**
     * Express request handler that sends back a response when a client has
     * reached their rate limit.
     */
    readonly onLimitReached: (request: Express.Request, response: Express.Response, optionsUsed: Options) => void;
    /**
